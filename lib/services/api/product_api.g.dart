...
class _ProductApi implements ProductApi {
  ...
  @override
  Future<Map<String, Product>> getProduct(String token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'auth': token};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Map<String, Product>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ProductId> addProduct(
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ProductId>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ProductId.fromJson(_result.data!);
    return value;
  }
